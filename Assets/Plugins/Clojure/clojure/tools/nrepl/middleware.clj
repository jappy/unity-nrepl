...
(def version
  {:major 0 :minor 1 :incremental 1 :qualifier "alpha"})
    ...
    (if (= op "describe")
      (transport/send transport (misc/response-for msg
                                  {:ops (if verbose?
                                   ...
                                   :versions {:nrepl (safe-version version)
                                              ;;(safe-version clojure.tools.nrepl/version)
                                              :clojure (safe-version version)
                                        ;(safe-version *clojure-version*)
                                              }
                                   :status :done}))
      (h msg))))
...
<small>generated from a verbose 'describe' response (Unity nREPL v"
